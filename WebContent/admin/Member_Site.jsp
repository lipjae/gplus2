...
<jsp:useBean id="memberSite_DTO" class="dto.LIST_MEMBER_DTO" />
<%
LIST_DAO memberSite_DAO = new LIST_DAO();
List<LIST_MEMBER_DTO> memberList = memberSite_DAO.getMemSiteList(memberSite_DTO);
%>
<!DOCTYPE html>
<html lang="ko">
<head>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="page-header">회원사(현장등록 건설사) 정보집계</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
